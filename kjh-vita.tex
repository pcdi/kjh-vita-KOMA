...
%% Set length of separator for additional information on entries
...
\AddtoDoHook{heading/begingroup/section}{\hspace*{\parindent}{}}

%% Set header to be sans-serif, footnote size
%% https://tex.stackexchange.com/a/344445/8432
...
%% Set header to be in the margin and flush left (ragged right)
\renewcommand{\sectioncatchphraseformat}[4]{%
    \Ifstr{#1}{section}
        {\marginnote{\raggedright#4}}
        {\hskip #2#3#4}%
}
