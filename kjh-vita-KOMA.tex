...
%% If you comment it out, be sure to remove the \ofoot comment below, too.
\input{vc}
...
\newfontface\headerfont[SmallCapsFont={EB Garamond},SmallCapsFeatures={Letters={SmallCaps,UppercaseSmallCaps}}]{EB Garamond}
...
%% Set heading to large size, small caps
\newcommand*{\scheader}[1]{\bigskip{\LARGE\headerfont\textsc{#1}}}

\newcommand*{\addressentry}[2]{{\footnotesize {#1}} & {\scriptsize #2} \\}
\newcommand*{\addresslink}[3]{{\scriptsize \texttt{\href{#1}{#2}}} & {\scriptsize #3} \\}
...
%%%------------------------------------------------------------------------
\noindent\begin{minipage}[t]{0.618\linewidth}
 \flushright {\footnotesize 
   \href{http://sociology.duke.edu}{Department of Sociology}, \\
   Box 90088, \\
   Duke University, \\
   Durham, \textsc{nc} 27708.\par}
\end{minipage}
\begin{minipage}[t]{0.382\linewidth}
\footnotesize\hfill
  \begin{tabular}[t]{rc}
    \addressentry{\myphone}{\faPhone}
    \addresslink{http://twitter.com/kjhealy}{\mytwitter}{\faTwitter}
    \addresslink{mailto:\myemail}{\myemail}{\faEnvelope}
    \addresslink{\myweb}{\myweb}{\faGlobe}
  \end{tabular}
\end{minipage}\par


%% Name 
\scheader{Kieran Healy’s CV Template}
\reversemarginpar
